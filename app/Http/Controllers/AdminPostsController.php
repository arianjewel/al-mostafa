<?php namespace App\Http\Controllers;
	...
	class AdminPostsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Image","name"=>"image","image"=>true,"width"=>"55"];
			...
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'wysiwyg','validation'=>'string|max:5000','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select2','validation'=>'integer','width'=>'col-sm-10','datatable'=>'categories,name'];
			...
			//$this->form[] = ['label'=>'Category','name'=>'category_id','type'=>'select2','validation'=>'integer','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			# OLD END FORM
