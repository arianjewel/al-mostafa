<?php namespace App\Http\Controllers;
	...
	class AdminCertificatesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Image","name"=>"image","image"=>true,"width"=>"40"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'max:170','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
