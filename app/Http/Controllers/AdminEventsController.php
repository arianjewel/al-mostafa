<?php namespace App\Http\Controllers;
	...
	class AdminEventsController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Time","name"=>"time" );
		$this->col[] = array("label"=>"Status","name"=>"status" );
		$this->col[] = array("label"=>"Venue","name"=>"venue" );
		$this->col[] = array("label"=>"Body","name"=>"body" );
			...
			$this->form[] = ['label'=>'Time','name'=>'time','type'=>'datetime','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Venue','name'=>'venue','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'wysiwyg','validation'=>'max:5000','width'=>'col-sm-10'];
