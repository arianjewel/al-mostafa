<?php namespace App\Http\Controllers;
	...
	class AdminPartnersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Logo","name"=>"image","image"=>true,"width"=>"40"];
			...
			$this->form[] = ['label'=>'Logo','name'=>'image','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
